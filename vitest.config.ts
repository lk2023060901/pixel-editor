...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@pixel-editor/automapping": fromRepositoryRoot("./packages/automapping/src/index.ts"),
      ...
      "@pixel-editor/template": fromRepositoryRoot("./packages/template/src/index.ts"),
      "@pixel-editor/world": fromRepositoryRoot("./packages/world/src/index.ts"),
      ...
      "@pixel-editor/tiled-world": fromRepositoryRoot("./packages/tiled-world/src/index.ts"),
      "@pixel-editor/tiled-automapping": fromRepositoryRoot("./packages/tiled-automapping/src/index.ts"),
